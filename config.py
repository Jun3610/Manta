...
#
# 현재 적용 규칙 (기본 근무시간: 8시간 — 사용자 명시 시 그 값이 우선):
#   OP (오픈): 오전 6시 ~ 오후 3시  (휴게 12:00~13:00)
#   CL (마감): 오후 3시 ~ 자정      (휴게 18:00~19:00)
DEFAULT_SHIFT_RULES: dict[str, tuple[str, str]] = {
    "OP": ("06:00", "15:00"),   # 오픈 근무 (06:00~15:00, 기본 8시간)
    "CL": ("15:00", "24:00"),   # 마감 근무 (15:00~24:00, 기본 8시간)
}

# ====== 5. 자동 규칙 제외 키워드 (OVERTIME_KEYWORDS) ======
# 이 키워드가 감지되면 OP/CL 자동 추론을 적용하지 않고,
# Approval 단계 이전에 사용자에게 정확한 시간을 되물어봐야 한다.
OVERTIME_KEYWORDS: list[str] = ["추가근무", "추가 근무", "연장근무", "연장 근무", "오버타임", "overtime"]